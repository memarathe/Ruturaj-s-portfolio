    ...
    <>
      <div>
        <Head>
          ...
          <meta property="og:title" content="Ruturaj Marathe" />
          <meta property="og:type" content="website" />
          <meta property="og:locale" content="en_IE" />
          <meta name="twitter:card" content="summary_large_image" />
          <meta property="og:site_name" content="Ruturaj's Portfolio" />
      ...
      <Certifications />
      <div className="mt-20">
        © {new Date().getFullYear()} Ruturaj Marathe. United States.
      </div>
    </>
  );
}
