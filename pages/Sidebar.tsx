      ...
      <header className="lg:sticky lg:top-0 lg:flex lg:max-h-screen lg:w-1/2 lg:flex-col lg:justify-between lg:py-16">
        <div>
          ...
          <div className="mt-4 max-w-xs flex gap-4">
            <Link
              href="/resume/Ruturaj-Marathe.pdf"
        ...
        >
          <li className="mr-5 text-xs">
            <a
              ...
              href="https://www.facebook.com/profile.php?id=100008115764516"
              target="_blank"
              rel="noreferrer"
            >
          ...
          <li className="mr-5 text-xs">
            <a
              className="block hover:text-white"
              href="https://www.linkedin.com/in/ruturaj-marathe/"
              target="_blank"
              rel="noreferrer"
            >
          ...
          <li className="mr-5 text-xs">
            <a
              className="block hover:text-white"
              href="https://github.com/memarathe"
              target="_blank"
              rel="noreferrer"
            >
